...
const faqItems = [
  ...
  },
  {
    ...
    a: "ChatGPT — чат. Kent — ассистент. Разница: память, 17 специализированных скиллов, интеграции с почтой и календарём, проактивные напоминания. И стоит дешевле: от 2990 ₽/мес вместо 3200 ₽ за ChatGPT Plus.",
  },
  {
